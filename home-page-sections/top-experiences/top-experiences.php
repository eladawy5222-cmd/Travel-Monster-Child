                                ...
                                <div class="fts-te-card-footer">
                                    <div class="fts-te-card-prices">
                                        <?php if ( $p['old_price'] > 0 ) : ?>
                                            ...
                                            ?>
                                            <span class="fts-te-card-old-price"><?php echo esc_html( $p['symbol'] . number_format( $p['old_price'], $_dec ) ); ?></span>
                                        <?php endif; ?>
                                        <div class="fts-te-card-current">
                                            ...
                                            ?>
                                            <span class="fts-te-card-price"><?php echo esc_html( $p['symbol'] . number_format( $p['display_price'], $_dec ) ); ?></span>
                                        </div>
                                    </div>
