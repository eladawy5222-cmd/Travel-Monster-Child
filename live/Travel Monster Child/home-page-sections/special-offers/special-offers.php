                                ...
                                <div class="fts-so-card-footer">
                                    <div class="fts-so-card-prices">
                                        <?php if ( $p['old_price'] > 0 ) : ?>
                                            <?php
                                                $_wte_s = get_option( 'wp_travel_engine_settings', array() );
                                                $_dec = isset( $_wte_s['decimal_digits'] ) && $_wte_s['decimal_digits'] !== 'default' ? intval( $_wte_s['decimal_digits'] ) : 0;
                                            ?>
                                            <span class="fts-so-card-old-price"><?php echo esc_html( $p['symbol'] . number_format( $p['old_price'], $_dec ) ); ?></span>
                                        <?php endif; ?>
                                        <div class="fts-so-card-current">
                                            ...
                                            ?>
                                            <span class="fts-so-card-price"><?php echo esc_html( $p['symbol'] . number_format( $p['display_price'], $_dec ) ); ?></span>
                                        </div>
                                    </div>
